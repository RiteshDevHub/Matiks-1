// LossScreen — shared component shown when a player loses a duel.
// Matches the "Loss — Dice Detective" design reference.
...
const imgLossLevel   = "/assets/victory-loss-level.svg";
const imgReaction    = "/assets/victory-reaction.svg";
const imgLossChevron = "/assets/victory-loss-chevron.svg";
    ...
    >
      <div className="w-full max-w-[460px] mx-auto flex flex-col flex-1 justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* Grid / game-modes icon with red accent */}
          <button
            type="button"
          ...
          >
            ...
            >
              {[LOSS_ACCENT, "#313131", "#313131", LOSS_ACCENT].map((bg, i) => (
                <span
                  key={i}
                  style={{
                    background: bg,
          ...
          >
            <img src={imgLossLevel} alt="" style={{ width: 23, height: 23 }} />
          </button>
        </div>
      </nav>
        ...
        >
          <h1
            style={{
              ...
              textAlign: "center",
              whiteSpace: "nowrap",
              WebkitTextStroke: `1px ${LOSS_ACCENT}`,
              textShadow: `0 3px 0 ${LOSS_ACCENT}`,
        ...
        <div className="flex gap-3 w-full max-w-[420px]" style={{ padding: "24px 20px 0" }}>
          <button
            ...
            style={{
              ...
              padding: "0 20px",
              borderRadius: 12,
              border: `1px solid ${LOSS_ACCENT}`,
              background: "#1a1c20",
              boxShadow: `0 4px 0 ${LOSS_ACCENT}`,
              color: LOSS_ACCENT,
              fontSize: 16,
              fontWeight: 500,
              lineHeight: "24px",
      ...
      >
        ...
        <div className="flex w-full gap-2 mt-2" style={{ flexShrink: 0 }}>
          <StatCard label="FLOWS" icon={imgFlows} iconBg={LOSS_ACCENT} value={flows} />
...
function PlayerCard({ score, name, rating, ratingChange, isWinner, accentColor }: PlayerCardProps) {
  return (
    <div className="flex flex-col items-center" style={{ flex: 1, minWidth: 0 }}>
      ...
      <div
        style={{
          height: 72,
          color: isWinner ? accentColor : "#313131",
          fontFamily: "Impact, Anton, sans-serif",
          fontSize: 72,
          fontWeight: 400,
          lineHeight: "72px",
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            borderRadius: 4,
            background: ratingChange > 0 ? accentColor : "#171717",
